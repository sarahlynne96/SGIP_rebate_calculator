    ...
    <form id="calcForm" autocomplete="off" novalidate>
      ...
      <fieldset>
        ...
        <details style="margin-top:1rem">
          ...
          <div>
            <iframe src="https://experience.arcgis.com/experience/1c21c53da8de48f1b946f3402fbae55c" width="100%" height="300" style="border:none; margin-top:.5rem"></iframe>
            <iframe src="https://capuc.maps.arcgis.com/apps/webappviewer/index.html?id=5bdb921d747a46929d9f00dbdb6d0fa2" width="100%" height="300" style="border:none; margin-top:.5rem"></iframe>
            <p style="margin-top:.5rem;"><a href="https://capuc.maps.arcgis.com/apps/dashboards/ecd21b1c204f47da8b1fcc4c5c3b7d3a" target="_blank" rel="noopener">Open CPUC Public PSPS Dashboard</a></p>
          </div>
        </details>
      </fieldset>
